...
fn min_distance(v1: &mut Vec<(i32, i32)>, v2: &mut Vec<(i32, i32)>) -> i32 {
    ...
    'outer: for (i, x) in v1.iter().enumerate() {
        for j in 0..min(distance-i, v2.len()) {
            let y = v2[j];
            if (x.0, x.1) == y {
                distance = i + j + 2;
            }
...
mod tests {
    ...
    fn sub13() {
        assert_eq!(
            sub1("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51\nU98,R91,D20,R16,D67,R40,U7,R15,U6,R7"),
            135
        );
    }
    ...
    fn sub23() {
        assert_eq!(
            sub2("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51\nU98,R91,D20,R16,D67,R40,U7,R15,U6,R7"),
            410
        );
    }
}